...
export default function ProjectsPage() {
  ...
  return (
    <div className="pt-12 pb-32 px-4">
      <div className="max-w-container mx-auto glass-surface rounded-[32px] overflow-hidden py-12 md:py-24">
        <header className="px-6 md:px-16 mb-10 md:mb-16">
          <h1 className="text-[clamp(2.5rem,8vw,4.5rem)] leading-[1.05] font-extrabold tracking-[-0.04em] text-primary mb-4">
            Selected Projects
          </h1>
        ...
        <section className="px-6 md:px-16 mb-8 md:mb-12">
            ...
            {filters.map((f) => {
              ...
              return (
                <button
                  key={f}
                  onClick={() => setActive(f)}
                  className={`px-5 py-2.5 rounded-full border text-xs uppercase tracking-[0.1em] font-semibold font-[var(--font-jetbrains)] transition-all ${
                    isActive
        ...
        <section className="px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          {visible.map((p) => (
            <article
              key={p.title}
            ...
            >
              ...
              <div className="p-6 md:p-8 flex-1 flex flex-col">
                <div className="flex justify-between items-start gap-3 mb-4">
                  <h3 className="text-2xl md:text-3xl font-semibold tracking-[-0.01em] text-on-surface">
                    {p.title}
                  </h3>
